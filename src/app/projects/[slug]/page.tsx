...
export default async function ProjectDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-b from-[#7C8C70] via-[#8E6B53] to-[#E5D9C4] font-ivymode flex flex-col">
      
      {/* ─── MAIN CONTENT CONTAINER ─── */}
      <div className="flex-1 w-full max-w-[92%] sm:max-w-[88%] md:max-w-[85%] mx-auto pt-24 sm:pt-32 pb-24">
