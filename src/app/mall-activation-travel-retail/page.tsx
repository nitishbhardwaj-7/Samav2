...
import { getMallActivationProjects, getHomepageData, getMallActivationPageData, getPageMetadata } from "../../lib/wordpress";

export const revalidate = 3600;

export async function generateMetadata() {
  return getPageMetadata(1113);
}
...
export default async function MallActivationPage() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col">
      ...
      >
        {/* ─── HEADER ───────────────────────────────────────────── */}
        <InteriorHeader title={title} description={description} breadcrumbLabel="Mall Activation & Travel Retail" />
        ...
        <section className="relative w-full py-12 sm:py-16 px-4 sm:px-8 md:px-12 lg:px-16 flex-grow">
          <div className="w-full max-w-[92%] sm:max-w-[88%] md:max-w-[85%] mx-auto">
            ...
            <FadeUp delay={0.3} className="w-full flex flex-col items-center justify-center gap-6 mt-16 text-center px-4">
              ...
              <a
                href={ctaButtonUrl || "/uploads/SAMA-Production-Portfolio.pdf"}
                download
